...
| [docs/15-multi-printer-klipper-integration.md](docs/15-multi-printer-klipper-integration.md) | **Generic Multi-Printer Klipper Integration & Configuration Guide** — Portable setup for Snapmaker U1, Voron, and custom printers. Invariant protocol facts vs configurable geometry/sensors, and multi-vendor on-tag RFID extraction |
